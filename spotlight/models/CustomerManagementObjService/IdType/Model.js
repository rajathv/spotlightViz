...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "IdType", "objectService" : "CustomerManagementObjService"};
     ...
     */
    IdType.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("CustomerManagementObjService", "IdType", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    IdType.clone = function(objectToClone) {
        var clonedObj = new IdType();
