...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "CustomerRequestSummary", "objectService" : "DashboardObjService"};
     ...
     */
    CustomerRequestSummary.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("DashboardObjService", "CustomerRequestSummary", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    CustomerRequestSummary.clone = function(objectToClone) {
        var clonedObj = new CustomerRequestSummary();
