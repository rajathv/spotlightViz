...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "overallPaymentLimits", "objectService" : "ManageLimitsAndFees"};
     ...
     */
    overallPaymentLimits.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ManageLimitsAndFees", "overallPaymentLimits", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    overallPaymentLimits.clone = function(objectToClone) {
        var clonedObj = new overallPaymentLimits();
