...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "period", "objectService" : "ManageLimitsAndFees"};
     ...
     */
    period.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ManageLimitsAndFees", "period", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    period.clone = function(objectToClone) {
        var clonedObj = new period();
