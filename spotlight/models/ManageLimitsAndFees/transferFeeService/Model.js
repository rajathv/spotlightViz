...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "transferFeeService", "objectService" : "ManageLimitsAndFees"};
     ...
     */
    transferFeeService.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ManageLimitsAndFees", "transferFeeService", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    transferFeeService.clone = function(objectToClone) {
        var clonedObj = new transferFeeService();
