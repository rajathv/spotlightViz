...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "validateTransactionLimit", "objectService" : "ManageLimitsAndFees"};
     ...
     */
    validateTransactionLimit.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ManageLimitsAndFees", "validateTransactionLimit", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    validateTransactionLimit.clone = function(objectToClone) {
        var clonedObj = new validateTransactionLimit();
