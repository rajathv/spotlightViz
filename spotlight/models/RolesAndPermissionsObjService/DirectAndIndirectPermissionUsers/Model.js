...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "DirectAndIndirectPermissionUsers", "objectService" : "RolesAndPermissionsObjService"};
     ...
     */
    DirectAndIndirectPermissionUsers.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("RolesAndPermissionsObjService", "DirectAndIndirectPermissionUsers", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    DirectAndIndirectPermissionUsers.clone = function(objectToClone) {
        var clonedObj = new DirectAndIndirectPermissionUsers();
