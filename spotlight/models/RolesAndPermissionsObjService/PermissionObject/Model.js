...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "PermissionObject", "objectService" : "RolesAndPermissionsObjService"};
     ...
     */
    PermissionObject.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("RolesAndPermissionsObjService", "PermissionObject", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    PermissionObject.clone = function(objectToClone) {
        var clonedObj = new PermissionObject();
