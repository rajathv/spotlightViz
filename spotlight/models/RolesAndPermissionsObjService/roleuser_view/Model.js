...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "roleuser_view", "objectService" : "RolesAndPermissionsObjService"};
     ...
     */
    roleuser_view.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("RolesAndPermissionsObjService", "roleuser_view", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    roleuser_view.clone = function(objectToClone) {
        var clonedObj = new roleuser_view();
