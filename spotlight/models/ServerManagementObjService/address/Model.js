...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "address", "objectService" : "ServerManagementObjService"};
     ...
     */
    address.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ServerManagementObjService", "address", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    address.clone = function(objectToClone) {
        var clonedObj = new address();
