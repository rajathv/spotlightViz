...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "server", "objectService" : "ServerManagementObjService"};
     ...
     */
    server.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ServerManagementObjService", "server", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    server.clone = function(objectToClone) {
        var clonedObj = new server();
