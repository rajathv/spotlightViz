...
kony.sdk.performNoPopUpLogin = function(successCallback, failureCallback) {
	...
	if (!kony.sdk.isNullOrUndefined(queryParamsAsString) &&
		queryParamsAsString.indexOf(kony.sdk.constants.DEEPLINK_VALID_PARAM + kony.sdk.constants.EQUAL_TO) !== -1) {
	...
	if(!kony.sdk.isNullOrUndefined(appConfigString) && kony.sdk.isJson(appConfigString)) {
		...
		if(!kony.sdk.isNullOrUndefined(codeValue)) {
			...
			var errorObject = kony.sdk.error.getSingleWindowLoginErrObj(kony.sdk.errorcodes.invalid_auth_code,
				kony.sdk.errormessages.invalid_auth_code);
		...
		if(!kony.sdk.isNullOrUndefined(codeValue)) {
			...
			var errorObject = kony.sdk.error.getSingleWindowLoginErrObj(kony.sdk.errorcodes.invalid_appconfig,
			kony.sdk.errormessages.invalid_appconfig);
			metaDataManagerForLoginInSameWindow.destroy();
			kony.sdk.verifyAndCallClosure(failureCallback, errorObject);
		} else {
			metaDataManagerForLoginInSameWindow.destroy();
...
kony.sdk.completeSingleWindowLogin = function (code, loginCompleteCallback) {
	...
	if(kony.sdk.isNullOrUndefined(loginOptions)){
		...
		var errorObject = kony.sdk.error.getSingleWindowLoginErrObj(kony.sdk.errorcodes.partial_login_error,
			kony.sdk.errormessages.partial_login_error);
		kony.sdk.verifyAndCallClosure(failureCallback,errorObject);
		return;
	}
...
function OAuthHandler(serviceUrl, providerName, appkey, callback, type, options, isMFVersionCompatible) {
    if(options[kony.sdk.constants.IS_ENABLE_IDENTITY_PKCE] === true) {
        ...
        if(!kony.sdk.pkceUtilityInstance.initializePKCEObject()) {
            var err = kony.sdk.error.getErrObj(kony.sdk.errorcodes.pkce_params_generation_failed,
                kony.sdk.errormessages.pkce_params_generation_failed);
            var isErr = true;
	...
	if (typeof(XMLHttpRequest) !== 'undefined') {
            ...
            function saveAppVerifierSuccessCallback() {
                ...
                if (kony.sdk.isNullOrUndefined(userCustomDataSaveHandle)) {
                    ...
                    if (typeof (userCustomDataSaveHandle) !== 'function') {
                        ...
                        var errorObject = kony.sdk.error.getSingleWindowLoginErrObj(kony.sdk.errorcodes.invalid_custom_data_save_handle,
                            kony.sdk.errormessages.invalid_custom_data_save_handle);
                        isError = true;
                        metaDataManagerForLoginInSameWindow.destroy();
                        loginHelperFunction(null, null, null, isError, errorObject);
                        return;
                    ...
                    userCustomDataSaveHandle(_openWindowInSelfMode, function (err) {
                        ...
                        var errorObject = kony.sdk.error.getSingleWindowLoginErrObj(kony.sdk.errorcodes.custom_data_save_handle_failed,
                            kony.sdk.errormessages.custom_data_save_handle_failed);
                        isError = true;
                        metaDataManagerForLoginInSameWindow.destroy();
                        loginHelperFunction(null, null, null, isError, errorObject);
                        return;
        ...
        function handleOAuthLogoutSuccessCallback(browser){
            ...
            if (!kony.sdk.isNullOrUndefined(userDefinedBrowserOnSuccess))
                kony.sdk.verifyAndCallClosure(userDefinedBrowserOnSuccess, browser);
		...
		function handleOAuthLogoutFailureCallback(browser){
            ...
            if (!kony.sdk.isNullOrUndefined(userDefinedBrowserOnFailure))
                kony.sdk.verifyAndCallClosure(userDefinedBrowserOnFailure, browser);
            resetBrowserOnSuccessandFailureEvents(browser);
		}
                    ...
                    if (!isLoginCallbackInvoked) {
                        ...
                        kony.timer.schedule(new Date().getTime().toString(), function (url, callback, code, headers) {
                            return function () {
                                ...
                                if(!(kony.sdk.isNullOrUndefined(kony.sdk.pkceUtilityInstance) ||
                                     kony.sdk.isNullOrUndefined(params.queryParams.oauth_session_id))) {
...
function konyNetHttpRequest(url, params, headers, httpMethod, konyContentType, successCallback, failureCallback, options) {
    ...
    function localRequestCallback(result) {
        ...
        if (readyState === 4) {
            ...
            if(responseHeaders && (responseHeaders.hasOwnProperty(kony.sdk.constants.PASSTHROUGH_RESPONSE_HEADER.toLowerCase())
                                || responseHeaders.hasOwnProperty(kony.sdk.constants.PASSTHROUGH_RESPONSE_HEADER)) && (kony.sdk.convertPassthroughResponseToJson !== true)) {
            ...
            if(isInvalidResponse || (!response &&  status >= 200 && status < 300)){
                ...
                if (response.opstatus == 0 || (response.opstatus >= 500100 && response.opstatus <= 500200)) {
                    if(responseHeaders && (responseHeaders.hasOwnProperty(kony.sdk.constants.PASSTHROUGH_RESPONSE_HEADER.toLowerCase())
                                        || responseHeaders.hasOwnProperty(kony.sdk.constants.PASSTHROUGH_RESPONSE_HEADER))) {
                ...
                for (var index = 0; index < providers.length; index++) {
                    ...
                    if (persistedProvidersList.indexOf(provider) != -1) {
                        if (!kony.sdk.isNullOrUndefined(backendRefreshTokens[provider]) &&
                            konyRef.refreshLoginProvidersSet.has(provider)) {
    ...
    function helperClassPKCE() {
        ...
        this.appendAppChallengeOnURL = function (url) {
            if (!kony.sdk.isNullOrUndefined(secureParams) && !kony.sdk.isNullOrUndefined(url)) {
                url += "&" + kony.sdk.constants.APP_CHALLENGE + kony.sdk.constants.EQUAL_TO + secureParams[kony.sdk.constants.APP_CHALLENGE]
                    + "&" + kony.sdk.constants.KEY_APP_CHALLENGE_METHOD + kony.sdk.constants.EQUAL_TO
                    + kony.sdk.constants.APP_CHALLENGE_METHOD_VALUE;
                if(kony.sdk.getPlatformName() === kony.sdk.constants.PLATFORM_THIN_CLIENT) {
                    url += "&" + kony.sdk.constants.OAUTH_SESSION_RESPONSE_TYPE + kony.sdk.constants.EQUAL_TO
                        + kony.sdk.constants.HEADER;
                } else {
                    url += "&" + kony.sdk.constants.OAUTH_SESSION_RESPONSE_TYPE + kony.sdk.constants.EQUAL_TO
                        + kony.sdk.constants.QUERY;
                }
        ...
        this.retrieveAppVerifier = function (successCallback, failureCallback) {
            ...
            function _getCodeVerifier() {
                ...
                networkProvider.get(middlewareStateUrl, null, headers, function (response){
                    ...
                    var errorObject = kony.sdk.error.getSingleWindowLoginErrObj(kony.sdk.errorcodes.app_verifier_retrieve_failed,
                        kony.sdk.errormessages.app_verifier_retrieve_failed);
                    kony.sdk.verifyAndCallClosure(failureCallback, errorObject);
                }, null, networkOptions);
            }
        ...
        this.saveAppVerifier = function (appVerifierJSON, successCallback, failureCallback) {
            ...
            function _saveAppVerifier() {
                ...
                networkProvider.post(middlewareStateUrl, appVerifierJSON, headers, function (response) {
                    ...
                    kony.sdk.logsdk.error("unable to save the app verifier at middleware " + middlewareStateUrl + " , due to " + err.message);
                    var errorObject = kony.sdk.error.getSingleWindowLoginErrObj(kony.sdk.errorcodes.app_verifier_save_failed,
                        kony.sdk.errormessages.app_verifier_save_failed);
                    kony.sdk.verifyAndCallClosure(failureCallback, errorObject);
                }, kony.sdk.constants.CONTENT_TYPE_JSON, networkOptions);
            }
