define([], function() {
  	...
  	function TestCase_Groups_fetchEntitlementsOfGroup_CH(commandId) {
        kony.mvc.Business.CommandHandler.call(this, commandId);
    }
	
    inheritsFrom(TestCase_Groups_fetchEntitlementsOfGroup_CH, kony.mvc.Business.CommandHandler);
  
  	TestCase_Groups_fetchEntitlementsOfGroup_CH.prototype.execute = function(command){
		...
		try {
			groupsModule.businessController.execute(new kony.mvc.Business.Command("com.kony.CustomerGroups.getEntitlements", requestParam, onFetchCompletion));
		} catch (e) {
			this.sendResponse(command, kony.mvc.constants.STATUS_Failure, e);
		}
    };
	
	TestCase_Groups_fetchEntitlementsOfGroup_CH.prototype.validate = function(){
		
    };
    
    return TestCase_Groups_fetchEntitlementsOfGroup_CH;
