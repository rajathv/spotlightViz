define([], function() {
  	...
  	function TestCase_Messages_updateRequestStatus(commandId) {
        kony.mvc.Business.CommandHandler.call(this, commandId);
    }
	
    inheritsFrom(TestCase_Messages_updateRequestStatus, kony.mvc.Business.CommandHandler);
  
  	TestCase_Messages_updateRequestStatus.prototype.execute = function(command){
   ...
   try{
	...
	TestCase_Messages_updateRequestStatus.prototype.validate = function(){
		
    };
    
    return TestCase_Messages_updateRequestStatus;
