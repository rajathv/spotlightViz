define([], function() {
  	...
  	function TestCase_Role_fetchRolePermissions_CommandHandler(commandId) {
        kony.mvc.Business.CommandHandler.call(this, commandId);
    }
	
    inheritsFrom(TestCase_Role_fetchRolePermissions_CommandHandler, kony.mvc.Business.CommandHandler);
  
  	TestCase_Role_fetchRolePermissions_CommandHandler.prototype.execute = function(command){
        ...
        function onFetchRolesCompletion(response) {
            try {
                ...
                role_id = response.data.roles_view[0].role_id;
                RoleModule.businessController.execute(new kony.mvc.Business.Command("com.kony.role.fetchRolePermissions", role_id, onFetchRoleUsersCompletion));
            } catch (e) {
                this.sendResponse(command, kony.mvc.constants.STATUS_Failure, e);
            }
        }
	...
	TestCase_Role_fetchRolePermissions_CommandHandler.prototype.validate = function(){
		
    };
    
    return TestCase_Role_fetchRolePermissions_CommandHandler;
