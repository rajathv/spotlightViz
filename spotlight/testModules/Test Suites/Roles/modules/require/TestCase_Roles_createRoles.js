define([], function() {
  	...
  	function TestCase_Roles_createRoles(commandId) {
        kony.mvc.Business.CommandHandler.call(this, commandId);
    }
	
    inheritsFrom(TestCase_Roles_createRoles, kony.mvc.Business.CommandHandler);
  
  	TestCase_Roles_createRoles.prototype.execute = function(command){
   ...
   try{
               if(viewModel&&viewModel.fetchRoleList){
                    ...
                    RoleModule.presentationController.createRoleDetails("",inputParam);
              }
   }catch(e){
    self.sendResponse(command, kony.mvc.constants.STATUS_Failure, e);
   }
	...
	TestCase_Roles_createRoles.prototype.validate = function(){
		
    };
    
    return TestCase_Roles_createRoles;
