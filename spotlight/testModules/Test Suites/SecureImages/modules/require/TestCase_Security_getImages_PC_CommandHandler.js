define([], function() {
  ...
  function TestCase_Security_getImages_PC_CommandHandler(commandId) {
    kony.mvc.Business.CommandHandler.call(this, commandId);
  }

  inheritsFrom(TestCase_Security_getImages_PC_CommandHandler, kony.mvc.Business.CommandHandler);

  TestCase_Security_getImages_PC_CommandHandler.prototype.execute = function (command) {
    var self = this;
    ...
    securityModule.presentationController.navigateTo('SecurityModule','fetchAllImages');
  ...
  TestCase_Security_getImages_PC_CommandHandler.prototype.validate = function(){
  };

  return TestCase_Security_getImages_PC_CommandHandler;
